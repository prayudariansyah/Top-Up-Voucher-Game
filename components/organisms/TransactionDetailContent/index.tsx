          ...
          <div className="main-content main-content-card overflow-auto">
            <section className="checkout mx-auto">
              ...
              <div className="purchase pt-30">
                ...
                <Row label="Toral" value={55060600} className="color-palette-4" />
              </div>
              <div className="payment pt-10 pb-10">
                ...
                <Row label="Bank Account Name" value="PT Store Yuda Indonesia" />
                <Row label="Bank Number" value="1800 - 9090 - 2022" />
              </div>
