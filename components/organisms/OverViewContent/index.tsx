      ...
      <div className="ps-lg-0">
        ...
        <div className="top-up-categories mb-30">
          ...
          <div className="main-content">
            <div className="row">
              <Category nominal={18500000} icon="ic-destop">
                Game
                <br />
                Desktop
              </Category>
              ...
              <Category nominal={5000000} icon="ic-destop">
                Others
                <br />
                Categories
              </Category>
        ...
        <div className="latest-transaction">
          ...
          <div className="main-content main-content-table overflow-auto">
            <table className="table table-borderless">
              ...
              <tbody>
                <TableRow image="overview-1" title="Mobile Legend" categori="Desktop" item={200} price={200000} status="Pending" />
